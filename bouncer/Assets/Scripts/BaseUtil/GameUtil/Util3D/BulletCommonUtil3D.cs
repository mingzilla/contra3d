...
namespace BaseUtil.GameUtil.Util3D
{
    ...
    {
        public static Rigidbody AddRigidbodyToBullet(GameObject gameObject)
        {
        ...
        public static void HandleBulletMovement(Rigidbody theRB, Vector3 moveDirection, float bulletSpeed)
        {
