...
namespace ProjectContent.Scripts.Types
{
    public class Skill
    {
        ...
        public static readonly Skill FIRE_BOUNCE_BALL = Create("FIRE_BOUNCE_BALL", "Fire Bounce Ball", ElementalType.FIRE, "skill__fire__fire-bounce-ball", 3, 1, 1f, 20f, true, 3f);
        public static readonly Skill BIG_FIRE_BALL = Create("BIG_FIRE_BALL", "Big Fire Ball", ElementalType.FIRE, "skill__fire__fire-strike", 5, 1, 1f, 20f, true, 3f);
        public static readonly Skill METEOR_STORM = Create("METEOR_STORM", "Meteor Storm", ElementalType.FIRE, "skill__fire__meteor-storm", 10, 1, 1f, 20f, true, 3f);
        public static readonly Skill FIRE_SPRAY = Create("FIRE_SPRAY", "Fire Spray", ElementalType.FIRE, "skill__fire__meteor-storm", 10, 1, 1f, 20f, true, 3f);
